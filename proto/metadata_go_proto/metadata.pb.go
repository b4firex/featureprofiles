...
type Metadata_Deviations struct {
	...
	// Cisco: TODO add bug
	// Device requires Route Distinguisher to be set on the VRF before BGP afi-safis can be activated.
	SetRouteDistinguisherOnVrfBeforeActivatingBgpAfiSafis bool `protobuf:"varint,392,opt,name=set_route_distinguisher_on_vrf_before_activating_bgp_afi_safis,json=setRouteDistinguisherOnVrfBeforeActivatingBgpAfiSafis,proto3" json:"set_route_distinguisher_on_vrf_before_activating_bgp_afi_safis,omitempty"`
	unknownFields                                         protoimpl.UnknownFields
	sizeCache                                             protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetSetRouteDistinguisherOnVrfBeforeActivatingBgpAfiSafis() bool {
	if x != nil {
		return x.SetRouteDistinguisherOnVrfBeforeActivatingBgpAfiSafis
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xb6\xdb\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x82\xd1\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	">set_route_distinguisher_on_vrf_before_activating_bgp_afi_safis\x18\x88\x03 \x01(\bR5setRouteDistinguisherOnVrfBeforeActivatingBgpAfiSafisJ\x04\bT\x10UJ\x04\b\t\x10\n" +
